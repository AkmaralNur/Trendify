...
public class ShoppongCarGoodsAdapter extends RecyclerView.Adapter<ShoppongCarGoodsAdapter.ViewHolder> {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            iv_minus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (data.size() == 0) {
                        ToastUtil.showShort("Корзина пуста");
    ...
    private void refreshTotal() {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            a = result.divide(one, 2, BigDecimal.ROUND_HALF_UP).doubleValue(); // Округляем до 2 знаков
            total = a;
        }
