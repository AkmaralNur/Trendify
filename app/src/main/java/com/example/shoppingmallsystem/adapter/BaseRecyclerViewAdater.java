...
public abstract class BaseRecyclerViewAdater<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    // Конструктор с одним макетом и данными
    ...
    // Конструктор с несколькими макетами
    ...
    // Метод для возвращения типа представления (необходим для кастомизации)
    @Override
    ...
    /**
     * Метод для преобразования данных в представление
     * @param holder
     * @param position
     */
