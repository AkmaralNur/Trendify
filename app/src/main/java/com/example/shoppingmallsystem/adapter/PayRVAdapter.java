    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        switch (data.get(position).getPicNumb()) {
            ...
            case "9":
                ...
                break;
            case "11":
                holder.iv_pic.setImageResource(R.drawable.goods_12);
                break;
            case "12":
                holder.iv_pic.setImageResource(R.drawable.goods_13);
                break;
            case "13":
                holder.iv_pic.setImageResource(R.drawable.goods_14);
                break;
        }
